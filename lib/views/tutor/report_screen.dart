...
import '../../tutor_viewmodels/report_vm.dart';
...
class TutorReportScreen extends StatefulWidget {
  ...
  final String? contextName; // Optional - name for context

  const TutorReportScreen({
    super.key,
    this.againstUserId,
    this.bookingId,
    this.contextName,
...
class _TutorReportScreenState extends State<TutorReportScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        ...
        body: Consumer<TutorReportViewModel>(
  ...
  // ---------- Context Card ----------
  Widget _buildContextCard(TutorReportViewModel vm) {
    return Container(
  ...
  // ---------- Report Type Section ----------
  Widget _buildReportTypeSection(TutorReportViewModel vm) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const AppText(
        ...
        _buildTypeOption(
          ...
          description: 'Report issues with a parent or student',
        ),
  ...
  // ---------- Description Section ----------
  Widget _buildDescriptionSection(TutorReportViewModel vm) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const AppText(
