...
// Same as parent notifications screen (can be shared in future)
...
import '../../tutor_viewmodels/notification_vm.dart';
...
class _TutorNotificationsScreenState extends State<TutorNotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) {
        final vm = TutorNotificationViewModel();
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Consumer<TutorNotificationViewModel>(
  ...
  // ---------- Header ----------
  Widget _buildHeader(BuildContext context, TutorNotificationViewModel vm) {
    return Container(
  ...
  // ---------- Content ----------
  Widget _buildContent(BuildContext context, TutorNotificationViewModel vm) {
  ...
  Future<void> _handleNotificationTap(
    ...
    switch (type) {
      case 'booking_request':
        // Navigate to booking requests screen for tutors
        Navigator.pop(context); // Close notifications screen
        Get.to(() => const TutorBookingRequestsScreen());
        break;
      ...
      case 'message':
        ...
        if (senderId != null && senderId.isNotEmpty) {
          ...
          // This would require accessing TutorMainScreen, which is complex
      ...
      case 'session_reminder':
        // Navigate to booking requests screen to see the booking
        Navigator.pop(context); // Close notifications screen
        Get.to(() => const TutorBookingRequestsScreen());
        break;

      case 'booking_accepted_confirmation':
      case 'booking_rejected_confirmation':
        // These are self-confirmation notifications, just mark as read
