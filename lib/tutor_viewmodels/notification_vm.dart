// lib/tutor_viewmodels/notification_vm.dart
// Tutor Notification ViewModel
// Same implementation as parent (can be shared in future)
import 'dart:async';
...
class TutorNotificationViewModel extends ChangeNotifier {
  final NotificationService _notificationService;
  final FirebaseAuth _auth;

  TutorNotificationViewModel({
